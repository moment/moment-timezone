...
export const manipulate = {
	...
	isSame(t) {
		const m1 = moment.tz('2014-10-01T00:00:00', 'Europe/London');
		const m2 = moment.tz('2014-10-01T00:00:00', 'Europe/London');
		...
		const m3 = moment.tz('2014-09-09T00:00:00', 'America/Chicago');
		const m4 = moment.tz('2014-09-09T01:00:00', 'America/Toronto');
