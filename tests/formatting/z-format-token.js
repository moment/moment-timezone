...
exports.rules = {
    ...
    "America/New_York z format token" : function (test) {
        ...
        test.equal(moment("2012-05-11T04:00:00+00:00").tz("America/New_York").format("MMM D, YYYY h:mm A z"), "May 11w, 2012 12:00 AM EDT", "2011-01-01T04:59:59+00:00 should be May 11, 2012 12:00 AM EDT in America/New_York");
