...
exports["Europe/Stockholm"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Stockholm", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Stockholm", { abbr: true, expect: "Europe/Zurich" }),
