...
exports["Europe/Ljubljana"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Ljubljana", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Ljubljana", { abbr: true, expect: "Europe/Zurich" }),
