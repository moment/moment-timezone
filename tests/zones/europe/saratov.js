...
exports["Europe/Saratov"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Saratov", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Saratov", { abbr: true, expect: "Indian/Reunion" }),
