...
exports["Europe/Athens"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Athens", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Athens", { abbr: true, expect: "Europe/Zaporozhye" }),
