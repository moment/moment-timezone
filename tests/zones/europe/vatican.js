...
exports["Europe/Vatican"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Vatican", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Vatican", { abbr: true, expect: "Europe/Zurich" }),
