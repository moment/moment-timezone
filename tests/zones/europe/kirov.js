...
exports["Europe/Kirov"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Kirov", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Kirov", { abbr: true, expect: "Europe/Simferopol" }),
