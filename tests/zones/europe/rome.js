...
exports["Europe/Rome"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Rome", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Rome", { abbr: true, expect: "Europe/Zurich" }),
