...
exports["Europe/Ulyanovsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Ulyanovsk", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Ulyanovsk", { abbr: true, expect: "Indian/Reunion" }),
