...
exports["Europe/Tirane"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Tirane", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Tirane", { abbr: true, expect: "Europe/Zurich" }),
