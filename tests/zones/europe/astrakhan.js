...
exports["Europe/Astrakhan"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Astrakhan", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Astrakhan", { abbr: true, expect: "Indian/Reunion" }),
