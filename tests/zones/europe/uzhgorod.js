...
exports["Europe/Uzhgorod"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Uzhgorod", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Uzhgorod", { abbr: true, expect: "Europe/Zaporozhye" }),
