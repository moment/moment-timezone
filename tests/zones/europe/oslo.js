...
exports["Europe/Oslo"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Oslo", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Oslo", { abbr: true, expect: "Europe/Zurich" }),
