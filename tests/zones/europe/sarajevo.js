...
exports["Europe/Sarajevo"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Sarajevo", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Sarajevo", { abbr: true, expect: "Europe/Zurich" }),
