...
exports["Europe/Nicosia"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Nicosia", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Nicosia", { abbr: true, expect: "Europe/Zaporozhye" }),
