...
exports["Europe/San_Marino"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/San_Marino", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/San_Marino", { abbr: true, expect: "Europe/Zurich" }),
