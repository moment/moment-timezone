...
exports["Europe/Copenhagen"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Copenhagen", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Copenhagen", { abbr: true, expect: "Europe/Zurich" }),
