...
exports["Europe/Helsinki"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Helsinki", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Helsinki", { abbr: true, expect: "Europe/Zaporozhye" }),
