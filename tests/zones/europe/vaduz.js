...
exports["Europe/Vaduz"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Vaduz", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Vaduz", { abbr: true, expect: "Europe/Zurich" }),
