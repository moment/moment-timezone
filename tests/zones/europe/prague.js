...
exports["Europe/Prague"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Prague", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Prague", { abbr: true, expect: "Europe/Zurich" }),
