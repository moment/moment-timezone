...
exports["Europe/Budapest"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Budapest", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Budapest", { abbr: true, expect: "Europe/Zurich" }),
