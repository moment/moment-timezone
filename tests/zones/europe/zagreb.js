...
exports["Europe/Zagreb"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Zagreb", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Zagreb", { abbr: true, expect: "Europe/Zurich" }),
