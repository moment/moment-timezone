...
exports["Europe/Busingen"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Busingen", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Busingen", { abbr: true, expect: "Europe/Zurich" }),
