...
exports["Europe/Monaco"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Monaco", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Monaco", { abbr: true, expect: "Europe/Zurich" }),
