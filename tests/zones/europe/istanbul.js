...
exports["Europe/Istanbul"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Istanbul", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Istanbul", { abbr: true, expect: "Europe/Simferopol" }),
