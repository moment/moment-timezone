...
exports["Europe/Warsaw"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Warsaw", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Warsaw", { abbr: true, expect: "Europe/Zurich" }),
