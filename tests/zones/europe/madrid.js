...
exports["Europe/Madrid"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Madrid", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Madrid", { abbr: true, expect: "Europe/Zurich" }),
