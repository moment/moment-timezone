...
exports["Europe/Vienna"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Vienna", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Vienna", { abbr: true, expect: "Europe/Zurich" }),
