...
exports["Europe/Berlin"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Berlin", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Berlin", { abbr: true, expect: "Europe/Zurich" }),
