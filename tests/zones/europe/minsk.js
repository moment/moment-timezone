...
exports["Europe/Minsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Minsk", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Minsk", { abbr: true, expect: "Europe/Simferopol" }),
