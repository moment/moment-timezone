...
exports["Europe/Malta"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Malta", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Malta", { abbr: true, expect: "Europe/Zurich" }),
