...
exports["Europe/Sofia"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Sofia", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Sofia", { abbr: true, expect: "Europe/Zaporozhye" }),
