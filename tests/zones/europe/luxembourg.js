...
exports["Europe/Luxembourg"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Luxembourg", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Luxembourg", { abbr: true, expect: "Europe/Zurich" }),
