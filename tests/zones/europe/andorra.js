...
exports["Europe/Andorra"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Andorra", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Andorra", { abbr: true, expect: "Europe/Zurich" }),
