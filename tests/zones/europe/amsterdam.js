...
exports["Europe/Amsterdam"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Amsterdam", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Amsterdam", { abbr: true, expect: "Europe/Zurich" }),
