...
exports["Europe/Belgrade"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Belgrade", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Belgrade", { abbr: true, expect: "Europe/Zurich" }),
