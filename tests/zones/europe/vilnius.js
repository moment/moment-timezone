...
exports["Europe/Vilnius"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Vilnius", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Vilnius", { abbr: true, expect: "Europe/Zaporozhye" }),
