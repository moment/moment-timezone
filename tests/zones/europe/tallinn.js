...
exports["Europe/Tallinn"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Tallinn", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Tallinn", { abbr: true, expect: "Europe/Zaporozhye" }),
