...
exports["Europe/Podgorica"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Podgorica", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Podgorica", { abbr: true, expect: "Europe/Zurich" }),
