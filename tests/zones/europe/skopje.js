...
exports["Europe/Skopje"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Skopje", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Skopje", { abbr: true, expect: "Europe/Zurich" }),
