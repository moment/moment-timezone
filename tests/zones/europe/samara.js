...
exports["Europe/Samara"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Europe/Samara", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Europe/Samara", { abbr: true, expect: "Indian/Reunion" }),
