...
exports["Arctic/Longyearbyen"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Arctic/Longyearbyen", { offset: true, expect: "MET" }),

	"guess:by:abbr" : helpers.makeTestGuess("Arctic/Longyearbyen", { abbr: true, expect: "Europe/Zurich" }),
