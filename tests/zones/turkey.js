...
exports["Turkey"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Turkey", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Turkey", { abbr: true, expect: "Europe/Simferopol" }),
