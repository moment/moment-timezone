...
exports["Turkey"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Turkey", { offset: true, expect: "Europe/Istanbul" }),

	"guess:by:abbr" : helpers.makeTestGuess("Turkey", { abbr: true, expect: "Europe/Istanbul" }),
