...
exports["Indian/Mauritius"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Indian/Mauritius", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Indian/Mauritius", { abbr: true, expect: "Indian/Reunion" }),
