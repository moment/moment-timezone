...
exports["EET"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("EET", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("EET", { abbr: true, expect: "Europe/Zaporozhye" }),
