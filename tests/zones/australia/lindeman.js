...
exports["Australia/Lindeman"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Australia/Lindeman", { offset: true, expect: "Pacific/Port_Moresby" }),

	"guess:by:abbr" : helpers.makeTestGuess("Australia/Lindeman", { abbr: true }),
