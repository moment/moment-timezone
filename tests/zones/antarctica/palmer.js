...
exports["Antarctica/Palmer"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Antarctica/Palmer", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("Antarctica/Palmer", { abbr: true, expect: "Etc/GMT+3" }),
