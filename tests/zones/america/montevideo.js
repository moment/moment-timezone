...
exports["America/Montevideo"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Montevideo", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Montevideo", { abbr: true, expect: "Etc/GMT+3" }),
