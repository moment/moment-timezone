...
exports["America/Santarem"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Santarem", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Santarem", { abbr: true, expect: "Etc/GMT+3" }),
