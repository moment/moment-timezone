...
exports["America/Detroit"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Detroit", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Detroit", { abbr: true, expect: "EST5EDT" }),
