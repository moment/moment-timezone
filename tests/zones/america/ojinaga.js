...
exports["America/Ojinaga"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Ojinaga", { offset: true, expect: "America/Chicago" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Ojinaga", { abbr: true, expect: "America/Chicago" }),
