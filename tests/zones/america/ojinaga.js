...
exports["America/Ojinaga"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Ojinaga", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Ojinaga", { abbr: true, expect: "MST7MDT" }),
