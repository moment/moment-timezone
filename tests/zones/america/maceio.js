...
exports["America/Maceio"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Maceio", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Maceio", { abbr: true, expect: "Etc/GMT+3" }),
