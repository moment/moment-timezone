...
exports["America/Los_Angeles"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Los_Angeles", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Los_Angeles", { abbr: true, expect: "PST8PDT" }),
