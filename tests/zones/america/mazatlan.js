...
exports["America/Mazatlan"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Mazatlan", { offset: true, expect: "America/Phoenix" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Mazatlan", { abbr: true, expect: "America/Phoenix" }),
