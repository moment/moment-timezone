...
exports["America/Resolute"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Resolute", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Resolute", { abbr: true, expect: "CST6CDT" }),
