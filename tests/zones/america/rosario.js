...
exports["America/Rosario"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Rosario", { offset: true, expect: "America/Fortaleza" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Rosario", { abbr: true, expect: "America/Fortaleza" }),
