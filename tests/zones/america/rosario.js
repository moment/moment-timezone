...
exports["America/Rosario"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Rosario", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Rosario", { abbr: true, expect: "Etc/GMT+3" }),
