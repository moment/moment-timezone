...
exports["America/Toronto"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Toronto", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Toronto", { abbr: true, expect: "EST5EDT" }),
