...
exports["America/Recife"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Recife", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Recife", { abbr: true, expect: "Etc/GMT+3" }),
