...
exports["America/Yellowknife"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Yellowknife", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Yellowknife", { abbr: true, expect: "MST7MDT" }),
