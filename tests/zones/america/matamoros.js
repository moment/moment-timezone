...
exports["America/Matamoros"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Matamoros", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Matamoros", { abbr: true, expect: "CST6CDT" }),
