...
exports["America/Guayaquil"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Guayaquil", { offset: true, expect: "Etc/GMT+5" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Guayaquil", { abbr: true, expect: "Etc/GMT+5" }),
