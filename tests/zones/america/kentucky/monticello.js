...
exports["America/Kentucky/Monticello"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Kentucky/Monticello", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Kentucky/Monticello", { abbr: true, expect: "EST5EDT" }),
