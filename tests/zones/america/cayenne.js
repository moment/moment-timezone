...
exports["America/Cayenne"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cayenne", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cayenne", { abbr: true, expect: "Etc/GMT+3" }),
