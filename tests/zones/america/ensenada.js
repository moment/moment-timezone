...
exports["America/Ensenada"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Ensenada", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Ensenada", { abbr: true, expect: "PST8PDT" }),
