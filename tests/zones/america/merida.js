...
exports["America/Merida"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Merida", { offset: true, expect: "America/Monterrey" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Merida", { abbr: true, expect: "America/Monterrey" }),
