...
exports["America/Rankin_Inlet"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Rankin_Inlet", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Rankin_Inlet", { abbr: true, expect: "CST6CDT" }),
