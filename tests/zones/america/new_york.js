...
exports["America/New_York"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/New_York", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/New_York", { abbr: true, expect: "EST5EDT" }),
