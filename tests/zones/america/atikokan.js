...
exports["America/Atikokan"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Atikokan", { offset: true, expect: "Etc/GMT+5" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Atikokan", { abbr: true, expect: "EST" }),
