...
exports["America/Chicago"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Chicago", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Chicago", { abbr: true, expect: "CST6CDT" }),
