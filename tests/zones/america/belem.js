...
exports["America/Belem"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Belem", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Belem", { abbr: true, expect: "Etc/GMT+3" }),
