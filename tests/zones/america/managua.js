...
exports["America/Managua"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Managua", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Managua", { abbr: true, expect: "America/Tegucigalpa" }),
