...
exports["America/Moncton"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Moncton", { offset: true, expect: "Atlantic/Bermuda" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Moncton", { abbr: true, expect: "Atlantic/Bermuda" }),
