...
exports["America/Guyana"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Guyana", { offset: true, expect: "Etc/GMT+4" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Guyana", { abbr: true, expect: "Etc/GMT+4" }),
