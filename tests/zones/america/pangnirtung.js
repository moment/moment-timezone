...
exports["America/Pangnirtung"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Pangnirtung", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Pangnirtung", { abbr: true, expect: "EST5EDT" }),
