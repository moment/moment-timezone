...
exports["America/Regina"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Regina", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Regina", { abbr: true, expect: "America/Tegucigalpa" }),
