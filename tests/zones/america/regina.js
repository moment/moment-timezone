...
exports["America/Regina"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Regina", { offset: true, expect: "America/Mexico_City" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Regina", { abbr: true, expect: "America/Mexico_City" }),
