...
exports["America/Shiprock"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Shiprock", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Shiprock", { abbr: true, expect: "MST7MDT" }),
