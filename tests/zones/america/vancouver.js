...
exports["America/Vancouver"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Vancouver", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Vancouver", { abbr: true, expect: "PST8PDT" }),
