...
exports["America/Inuvik"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Inuvik", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Inuvik", { abbr: true, expect: "MST7MDT" }),
