...
exports["America/Inuvik"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Inuvik", { offset: true, expect: "America/Edmonton" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Inuvik", { abbr: true, expect: "America/Edmonton" }),
