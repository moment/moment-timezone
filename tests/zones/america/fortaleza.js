...
exports["America/Fortaleza"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Fortaleza", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Fortaleza", { abbr: true, expect: "Etc/GMT+3" }),
