...
exports["America/Boa_Vista"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Boa_Vista", { offset: true, expect: "Etc/GMT+4" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Boa_Vista", { abbr: true, expect: "Etc/GMT+4" }),
