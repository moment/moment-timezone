...
exports["America/Boise"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Boise", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Boise", { abbr: true, expect: "MST7MDT" }),
