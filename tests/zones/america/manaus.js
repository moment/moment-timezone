...
exports["America/Manaus"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Manaus", { offset: true, expect: "Etc/GMT+4" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Manaus", { abbr: true, expect: "Etc/GMT+4" }),
