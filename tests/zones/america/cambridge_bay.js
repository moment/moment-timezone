...
exports["America/Cambridge_Bay"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cambridge_Bay", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cambridge_Bay", { abbr: true, expect: "MST7MDT" }),
