...
exports["America/Belize"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Belize", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Belize", { abbr: true, expect: "America/Tegucigalpa" }),
