...
exports["America/Winnipeg"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Winnipeg", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Winnipeg", { abbr: true, expect: "CST6CDT" }),
