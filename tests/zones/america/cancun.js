...
exports["America/Cancun"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cancun", { offset: true, expect: "Etc/GMT+5" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cancun", { abbr: true, expect: "EST" }),
