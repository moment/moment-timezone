...
exports["America/Mendoza"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Mendoza", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Mendoza", { abbr: true, expect: "Etc/GMT+3" }),
