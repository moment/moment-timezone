...
exports["America/Jujuy"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Jujuy", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Jujuy", { abbr: true, expect: "Etc/GMT+3" }),
