...
exports["America/Buenos_Aires"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Buenos_Aires", { offset: true, expect: "America/Fortaleza" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Buenos_Aires", { abbr: true, expect: "America/Fortaleza" }),
