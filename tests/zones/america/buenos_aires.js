...
exports["America/Buenos_Aires"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Buenos_Aires", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Buenos_Aires", { abbr: true, expect: "Etc/GMT+3" }),
