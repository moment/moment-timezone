...
exports["America/Santa_Isabel"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Santa_Isabel", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Santa_Isabel", { abbr: true, expect: "PST8PDT" }),
