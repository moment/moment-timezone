...
exports["America/Iqaluit"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Iqaluit", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Iqaluit", { abbr: true, expect: "EST5EDT" }),
