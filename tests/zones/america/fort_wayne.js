...
exports["America/Fort_Wayne"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Fort_Wayne", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Fort_Wayne", { abbr: true, expect: "EST5EDT" }),
