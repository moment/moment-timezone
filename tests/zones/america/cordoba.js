...
exports["America/Cordoba"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cordoba", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cordoba", { abbr: true, expect: "Etc/GMT+3" }),
