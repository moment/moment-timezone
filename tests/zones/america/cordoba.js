...
exports["America/Cordoba"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cordoba", { offset: true, expect: "America/Sao_Paulo" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cordoba", { abbr: true, expect: "America/Sao_Paulo" }),

	"1894" : helpers.makeTestYear("America/Cordoba", [
