...
exports["America/Cordoba"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Cordoba", { offset: true, expect: "America/Fortaleza" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Cordoba", { abbr: true, expect: "America/Fortaleza" }),
