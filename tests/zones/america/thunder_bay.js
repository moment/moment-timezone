...
exports["America/Thunder_Bay"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Thunder_Bay", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Thunder_Bay", { abbr: true, expect: "EST5EDT" }),
