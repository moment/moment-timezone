...
exports["America/Tegucigalpa"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Tegucigalpa", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Tegucigalpa", { abbr: true }),
