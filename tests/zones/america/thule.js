...
exports["America/Thule"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Thule", { offset: true, expect: "Atlantic/Bermuda" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Thule", { abbr: true, expect: "Atlantic/Bermuda" }),
