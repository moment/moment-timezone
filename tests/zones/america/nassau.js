...
exports["America/Nassau"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Nassau", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Nassau", { abbr: true, expect: "EST5EDT" }),
