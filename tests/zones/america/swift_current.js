...
exports["America/Swift_Current"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Swift_Current", { offset: true, expect: "America/Mexico_City" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Swift_Current", { abbr: true, expect: "America/Mexico_City" }),
