...
exports["America/Bahia"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Bahia", { offset: true, expect: "America/Fortaleza" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Bahia", { abbr: true, expect: "America/Fortaleza" }),
