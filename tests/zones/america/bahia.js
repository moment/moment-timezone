...
exports["America/Bahia"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Bahia", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Bahia", { abbr: true, expect: "Etc/GMT+3" }),
