...
exports["America/Argentina/Ushuaia"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/Ushuaia", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/Ushuaia", { abbr: true, expect: "Etc/GMT+3" }),
