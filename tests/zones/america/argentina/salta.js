...
exports["America/Argentina/Salta"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/Salta", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/Salta", { abbr: true, expect: "Etc/GMT+3" }),
