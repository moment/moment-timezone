...
exports["America/Argentina/Rio_Gallegos"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/Rio_Gallegos", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/Rio_Gallegos", { abbr: true, expect: "Etc/GMT+3" }),
