...
exports["America/Argentina/Cordoba"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/Cordoba", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/Cordoba", { abbr: true, expect: "Etc/GMT+3" }),
