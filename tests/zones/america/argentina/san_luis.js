...
exports["America/Argentina/San_Luis"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/San_Luis", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/San_Luis", { abbr: true, expect: "Etc/GMT+3" }),
