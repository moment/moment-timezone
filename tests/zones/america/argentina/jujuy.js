...
exports["America/Argentina/Jujuy"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Argentina/Jujuy", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Argentina/Jujuy", { abbr: true, expect: "Etc/GMT+3" }),
