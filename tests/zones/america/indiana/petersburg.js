...
exports["America/Indiana/Petersburg"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Indiana/Petersburg", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Indiana/Petersburg", { abbr: true, expect: "EST5EDT" }),
