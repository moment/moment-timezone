...
exports["America/Indiana/Vevay"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Indiana/Vevay", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Indiana/Vevay", { abbr: true, expect: "EST5EDT" }),
