...
exports["America/Indiana/Vincennes"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Indiana/Vincennes", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Indiana/Vincennes", { abbr: true, expect: "EST5EDT" }),
