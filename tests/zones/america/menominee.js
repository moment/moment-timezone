...
exports["America/Menominee"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Menominee", { offset: true, expect: "CST6CDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Menominee", { abbr: true, expect: "CST6CDT" }),
