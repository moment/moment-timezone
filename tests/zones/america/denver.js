...
exports["America/Denver"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Denver", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Denver", { abbr: true, expect: "MST7MDT" }),
