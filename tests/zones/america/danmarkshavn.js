...
exports["America/Danmarkshavn"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Danmarkshavn", { offset: true, expect: "Etc/UTC" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Danmarkshavn", { abbr: true, expect: "Etc/UTC" }),
