...
exports["America/Araguaina"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Araguaina", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Araguaina", { abbr: true, expect: "Etc/GMT+3" }),
