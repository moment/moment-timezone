...
exports["America/Louisville"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Louisville", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Louisville", { abbr: true, expect: "EST5EDT" }),
