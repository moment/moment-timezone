...
exports["America/Paramaribo"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Paramaribo", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Paramaribo", { abbr: true, expect: "Etc/GMT+3" }),
