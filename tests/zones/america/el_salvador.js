...
exports["America/El_Salvador"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/El_Salvador", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/El_Salvador", { abbr: true, expect: "America/Tegucigalpa" }),
