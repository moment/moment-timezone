...
exports["America/Glace_Bay"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Glace_Bay", { offset: true, expect: "Atlantic/Bermuda" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Glace_Bay", { abbr: true, expect: "Atlantic/Bermuda" }),
