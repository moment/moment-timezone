...
exports["America/Coral_Harbour"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Coral_Harbour", { offset: true, expect: "Etc/GMT+5" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Coral_Harbour", { abbr: true, expect: "EST" }),
