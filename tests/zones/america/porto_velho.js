...
exports["America/Porto_Velho"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Porto_Velho", { offset: true, expect: "Etc/GMT+4" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Porto_Velho", { abbr: true, expect: "Etc/GMT+4" }),
