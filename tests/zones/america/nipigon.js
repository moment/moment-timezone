...
exports["America/Nipigon"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Nipigon", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Nipigon", { abbr: true, expect: "EST5EDT" }),
