...
exports["America/Fort_Nelson"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Fort_Nelson", { offset: true, expect: "MST" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Fort_Nelson", { abbr: true, expect: "MST" }),
