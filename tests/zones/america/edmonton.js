...
exports["America/Edmonton"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Edmonton", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Edmonton", { abbr: true, expect: "MST7MDT" }),
