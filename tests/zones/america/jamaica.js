...
exports["America/Jamaica"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Jamaica", { offset: true, expect: "Etc/GMT+5" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Jamaica", { abbr: true, expect: "EST" }),
