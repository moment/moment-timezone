...
exports["America/Dawson_Creek"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Dawson_Creek", { offset: true, expect: "MST" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Dawson_Creek", { abbr: true, expect: "MST" }),
