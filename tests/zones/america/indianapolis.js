...
exports["America/Indianapolis"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Indianapolis", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Indianapolis", { abbr: true, expect: "EST5EDT" }),
