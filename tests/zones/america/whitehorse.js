...
exports["America/Whitehorse"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Whitehorse", { offset: true, expect: "America/Whitehorse" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Whitehorse", { abbr: true, expect: "America/Whitehorse" }),
