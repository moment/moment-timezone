...
exports["America/Whitehorse"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Whitehorse", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Whitehorse", { abbr: true, expect: "PST8PDT" }),
