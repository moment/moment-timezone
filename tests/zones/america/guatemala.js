...
exports["America/Guatemala"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Guatemala", { offset: true, expect: "America/Mexico_City" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Guatemala", { abbr: true, expect: "America/Mexico_City" }),
