...
exports["America/Catamarca"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Catamarca", { offset: true, expect: "America/Sao_Paulo" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Catamarca", { abbr: true, expect: "America/Sao_Paulo" }),

	"1894" : helpers.makeTestYear("America/Catamarca", [
