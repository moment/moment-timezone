...
exports["America/Catamarca"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Catamarca", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Catamarca", { abbr: true, expect: "Etc/GMT+3" }),
