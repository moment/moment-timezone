...
exports["America/Catamarca"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("America/Catamarca", { offset: true, expect: "America/Fortaleza" }),

	"guess:by:abbr" : helpers.makeTestGuess("America/Catamarca", { abbr: true, expect: "America/Fortaleza" }),
