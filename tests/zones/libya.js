...
exports["Libya"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Libya", { offset: true, expect: "Europe/Kaliningrad" }),

	"guess:by:abbr" : helpers.makeTestGuess("Libya", { abbr: true, expect: "Europe/Kaliningrad" }),
