...
exports["Egypt"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Egypt", { offset: true, expect: "Europe/Kaliningrad" }),

	"guess:by:abbr" : helpers.makeTestGuess("Egypt", { abbr: true, expect: "Europe/Kaliningrad" }),
