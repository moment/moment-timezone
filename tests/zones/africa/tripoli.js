...
exports["Africa/Tripoli"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Africa/Tripoli", { offset: true, expect: "Europe/Kaliningrad" }),

	"guess:by:abbr" : helpers.makeTestGuess("Africa/Tripoli", { abbr: true, expect: "Europe/Kaliningrad" }),
