...
exports["Africa/Tripoli"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Africa/Tripoli", { offset: true, expect: "Africa/Johannesburg" }),

	"guess:by:abbr" : helpers.makeTestGuess("Africa/Tripoli", { abbr: true }),
