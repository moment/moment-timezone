...
exports["Africa/Khartoum"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Africa/Khartoum", { offset: true, expect: "Europe/Kaliningrad" }),

	"guess:by:abbr" : helpers.makeTestGuess("Africa/Khartoum", { abbr: true, expect: "Africa/Windhoek" }),
