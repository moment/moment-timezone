...
exports["Asia/Macao"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Macao", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Macao", { abbr: true, expect: "Asia/Taipei" }),

	"1904" : helpers.makeTestYear("Asia/Macao", [
