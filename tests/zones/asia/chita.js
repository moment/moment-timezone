...
exports["Asia/Chita"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Chita", { offset: true, expect: "Pacific/Palau" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Chita", { abbr: true, expect: "Pacific/Palau" }),
