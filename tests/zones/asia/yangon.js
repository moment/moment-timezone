...
exports["Asia/Yangon"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Yangon", { offset: true, expect: "Indian/Cocos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Yangon", { abbr: true, expect: "Indian/Cocos" }),
