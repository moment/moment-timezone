...
exports["Asia/Jakarta"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Jakarta", { offset: true, expect: "Indian/Christmas" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Jakarta", { abbr: true, expect: "Asia/Pontianak" }),
