...
exports["Asia/Gaza"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Gaza", { offset: true, expect: "Asia/Hebron" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Gaza", { abbr: true, expect: "Asia/Hebron" }),
