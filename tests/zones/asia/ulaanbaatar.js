...
exports["Asia/Ulaanbaatar"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Ulaanbaatar", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Ulaanbaatar", { abbr: true, expect: "Etc/GMT-8" }),
