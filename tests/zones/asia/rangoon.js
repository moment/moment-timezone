...
exports["Asia/Rangoon"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Rangoon", { offset: true, expect: "Indian/Cocos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Rangoon", { abbr: true, expect: "Indian/Cocos" }),
