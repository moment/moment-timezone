...
exports["Asia/Chongqing"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Chongqing", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Chongqing", { abbr: true, expect: "Asia/Taipei" }),
