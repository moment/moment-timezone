...
exports["Asia/Khandyga"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Khandyga", { offset: true, expect: "Pacific/Palau" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Khandyga", { abbr: true, expect: "Pacific/Palau" }),
