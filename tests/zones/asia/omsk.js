...
exports["Asia/Omsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Omsk", { offset: true, expect: "Indian/Chagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Omsk", { abbr: true, expect: "Indian/Chagos" }),
