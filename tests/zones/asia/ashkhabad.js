...
exports["Asia/Ashkhabad"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Ashkhabad", { offset: true, expect: "Asia/Karachi" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Ashkhabad", { abbr: true, expect: "Asia/Karachi" }),
