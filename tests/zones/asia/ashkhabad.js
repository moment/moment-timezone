...
exports["Asia/Ashkhabad"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Ashkhabad", { offset: true, expect: "Indian/Maldives" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Ashkhabad", { abbr: true, expect: "Indian/Maldives" }),
