...
exports["Asia/Kuala_Lumpur"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Kuala_Lumpur", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Kuala_Lumpur", { abbr: true, expect: "Etc/GMT-8" }),
