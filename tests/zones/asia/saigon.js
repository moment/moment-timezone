...
exports["Asia/Saigon"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Saigon", { offset: true, expect: "Indian/Christmas" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Saigon", { abbr: true, expect: "Indian/Christmas" }),
