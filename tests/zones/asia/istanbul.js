...
exports["Asia/Istanbul"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Istanbul", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Istanbul", { abbr: true, expect: "Europe/Simferopol" }),
