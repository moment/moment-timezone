...
exports["Asia/Shanghai"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Shanghai", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Shanghai", { abbr: true, expect: "Asia/Taipei" }),
