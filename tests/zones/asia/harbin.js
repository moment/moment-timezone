...
exports["Asia/Harbin"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Harbin", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Harbin", { abbr: true, expect: "Asia/Taipei" }),
