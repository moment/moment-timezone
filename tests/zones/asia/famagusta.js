...
exports["Asia/Famagusta"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Famagusta", { offset: true, expect: "Europe/Zaporozhye" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Famagusta", { abbr: true, expect: "Europe/Zaporozhye" }),
