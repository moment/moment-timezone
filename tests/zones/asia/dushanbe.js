...
exports["Asia/Dushanbe"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Dushanbe", { offset: true, expect: "Indian/Maldives" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Dushanbe", { abbr: true, expect: "Indian/Maldives" }),
