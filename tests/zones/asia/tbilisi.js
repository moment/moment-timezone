...
exports["Asia/Tbilisi"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Tbilisi", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Tbilisi", { abbr: true, expect: "Indian/Reunion" }),
