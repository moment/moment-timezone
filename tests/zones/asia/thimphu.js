...
exports["Asia/Thimphu"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Thimphu", { offset: true, expect: "Indian/Chagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Thimphu", { abbr: true, expect: "Indian/Chagos" }),
