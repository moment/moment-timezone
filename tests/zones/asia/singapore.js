...
exports["Asia/Singapore"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Singapore", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Singapore", { abbr: true, expect: "Etc/GMT-8" }),
