...
exports["Asia/Chungking"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Chungking", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Chungking", { abbr: true, expect: "Asia/Taipei" }),
