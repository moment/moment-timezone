...
exports["Asia/Yerevan"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Yerevan", { offset: true, expect: "Indian/Reunion" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Yerevan", { abbr: true, expect: "Indian/Reunion" }),
