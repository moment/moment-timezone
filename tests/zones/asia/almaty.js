...
exports["Asia/Almaty"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Almaty", { offset: true, expect: "Indian/Chagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Almaty", { abbr: true, expect: "Indian/Chagos" }),
