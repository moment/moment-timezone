...
exports["Asia/Thimbu"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Thimbu", { offset: true, expect: "Indian/Chagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Thimbu", { abbr: true, expect: "Indian/Chagos" }),
