...
exports["Asia/Sakhalin"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Sakhalin", { offset: true, expect: "Pacific/Pohnpei" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Sakhalin", { abbr: true, expect: "Pacific/Pohnpei" }),
