...
exports["Asia/Tashkent"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Tashkent", { offset: true, expect: "Indian/Maldives" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Tashkent", { abbr: true, expect: "Indian/Maldives" }),
