...
exports["Asia/Damascus"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Damascus", { offset: true, expect: "Europe/Moscow" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Damascus", { abbr: true, expect: "Europe/Moscow" }),
