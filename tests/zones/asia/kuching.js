...
exports["Asia/Kuching"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Kuching", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Kuching", { abbr: true, expect: "Etc/GMT-8" }),
