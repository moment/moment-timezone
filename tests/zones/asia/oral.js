...
exports["Asia/Oral"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Oral", { offset: true, expect: "Indian/Maldives" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Oral", { abbr: true, expect: "Indian/Maldives" }),
