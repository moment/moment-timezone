...
exports["Asia/Ashgabat"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Ashgabat", { offset: true, expect: "Indian/Maldives" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Ashgabat", { abbr: true, expect: "Indian/Maldives" }),
