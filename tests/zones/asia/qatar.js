...
exports["Asia/Qatar"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Qatar", { offset: true, expect: "Europe/Simferopol" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Qatar", { abbr: true, expect: "Europe/Simferopol" }),
