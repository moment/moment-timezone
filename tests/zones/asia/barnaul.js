...
exports["Asia/Barnaul"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Barnaul", { offset: true, expect: "Indian/Christmas" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Barnaul", { abbr: true, expect: "Indian/Christmas" }),
