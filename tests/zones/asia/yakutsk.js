...
exports["Asia/Yakutsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Yakutsk", { offset: true, expect: "Pacific/Palau" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Yakutsk", { abbr: true, expect: "Pacific/Palau" }),
