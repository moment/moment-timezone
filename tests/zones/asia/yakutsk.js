...
exports["Asia/Yakutsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Yakutsk", { offset: true, expect: "Asia/Tokyo" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Yakutsk", { abbr: true, expect: "Asia/Tokyo" }),
