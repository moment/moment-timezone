...
exports["Asia/Vladivostok"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Vladivostok", { offset: true, expect: "Pacific/Port_Moresby" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Vladivostok", { abbr: true, expect: "Pacific/Port_Moresby" }),
