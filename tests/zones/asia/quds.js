...
exports["Asia/Quds"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Quds", { offset: true, expect: "Asia/Gaza" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Quds", { abbr: true, expect: "Asia/Gaza" }),

	"1940" : helpers.makeTestYear("Asia/Quds", [
		["1940-05-31T21:59:59+00:00", "23:59:59", "EET", -120],
		["1940-05-31T22:00:00+00:00", "01:00:00", "EEST", -180]
	]),

	"1942" : helpers.makeTestYear("Asia/Quds", [
		["1942-10-31T20:59:59+00:00", "23:59:59", "EEST", -180],
		["1942-10-31T21:00:00+00:00", "23:00:00", "EET", -120]
	]),

	"1943" : helpers.makeTestYear("Asia/Quds", [
	...
	"1944" : helpers.makeTestYear("Asia/Quds", [
	...
	"1945" : helpers.makeTestYear("Asia/Quds", [
	...
	"1946" : helpers.makeTestYear("Asia/Quds", [
	...
	"1957" : helpers.makeTestYear("Asia/Quds", [
	...
	"1958" : helpers.makeTestYear("Asia/Quds", [
	...
	"1959" : helpers.makeTestYear("Asia/Quds", [
	...
	"1960" : helpers.makeTestYear("Asia/Quds", [
	...
	"1961" : helpers.makeTestYear("Asia/Quds", [
	...
	"1962" : helpers.makeTestYear("Asia/Quds", [
	...
	"1963" : helpers.makeTestYear("Asia/Quds", [
	...
	"1964" : helpers.makeTestYear("Asia/Quds", [
	...
	"1965" : helpers.makeTestYear("Asia/Quds", [
	...
	"1966" : helpers.makeTestYear("Asia/Quds", [
	...
	"1967" : helpers.makeTestYear("Asia/Quds", [
	...
	"1974" : helpers.makeTestYear("Asia/Quds", [
	...
	"1975" : helpers.makeTestYear("Asia/Quds", [
	...
	"1980" : helpers.makeTestYear("Asia/Quds", [
	...
	"1984" : helpers.makeTestYear("Asia/Quds", [
	...
	"1985" : helpers.makeTestYear("Asia/Quds", [
	...
	"1986" : helpers.makeTestYear("Asia/Quds", [
	...
	"1987" : helpers.makeTestYear("Asia/Quds", [
	...
	"1988" : helpers.makeTestYear("Asia/Quds", [
	...
	"1989" : helpers.makeTestYear("Asia/Quds", [
	...
	"1990" : helpers.makeTestYear("Asia/Quds", [
	...
	"1991" : helpers.makeTestYear("Asia/Quds", [
	...
	"1992" : helpers.makeTestYear("Asia/Quds", [
	...
	"1993" : helpers.makeTestYear("Asia/Quds", [
	...
	"1994" : helpers.makeTestYear("Asia/Quds", [
	...
	"1995" : helpers.makeTestYear("Asia/Quds", [
	...
	"1996" : helpers.makeTestYear("Asia/Quds", [
	...
	"1997" : helpers.makeTestYear("Asia/Quds", [
	...
	"1998" : helpers.makeTestYear("Asia/Quds", [
	...
	"1999" : helpers.makeTestYear("Asia/Quds", [
	...
	"2000" : helpers.makeTestYear("Asia/Quds", [
	...
	"2001" : helpers.makeTestYear("Asia/Quds", [
	...
	"2002" : helpers.makeTestYear("Asia/Quds", [
	...
	"2003" : helpers.makeTestYear("Asia/Quds", [
	...
	"2004" : helpers.makeTestYear("Asia/Quds", [
	...
	"2005" : helpers.makeTestYear("Asia/Quds", [
	...
	"2006" : helpers.makeTestYear("Asia/Quds", [
	...
	"2007" : helpers.makeTestYear("Asia/Quds", [
	...
	"2008" : helpers.makeTestYear("Asia/Quds", [
	...
	"2009" : helpers.makeTestYear("Asia/Quds", [
	...
	"2010" : helpers.makeTestYear("Asia/Quds", [
	...
	"2011" : helpers.makeTestYear("Asia/Quds", [
	...
	"2012" : helpers.makeTestYear("Asia/Quds", [
	...
	"2013" : helpers.makeTestYear("Asia/Quds", [
	...
	"2014" : helpers.makeTestYear("Asia/Quds", [
	...
	"2015" : helpers.makeTestYear("Asia/Quds", [
	...
	"2016" : helpers.makeTestYear("Asia/Quds", [
	...
	"2017" : helpers.makeTestYear("Asia/Quds", [
	...
	"2018" : helpers.makeTestYear("Asia/Quds", [
	...
	"2019" : helpers.makeTestYear("Asia/Quds", [
	...
	"2020" : helpers.makeTestYear("Asia/Quds", [
	...
	"2021" : helpers.makeTestYear("Asia/Quds", [
	...
	"2022" : helpers.makeTestYear("Asia/Quds", [
	...
	"2023" : helpers.makeTestYear("Asia/Quds", [
	...
	"2024" : helpers.makeTestYear("Asia/Quds", [
	...
	"2025" : helpers.makeTestYear("Asia/Quds", [
	...
	"2026" : helpers.makeTestYear("Asia/Quds", [
	...
	"2027" : helpers.makeTestYear("Asia/Quds", [
	...
	"2028" : helpers.makeTestYear("Asia/Quds", [
	...
	"2029" : helpers.makeTestYear("Asia/Quds", [
	...
	"2030" : helpers.makeTestYear("Asia/Quds", [
	...
	"2031" : helpers.makeTestYear("Asia/Quds", [
	...
	"2032" : helpers.makeTestYear("Asia/Quds", [
	...
	"2033" : helpers.makeTestYear("Asia/Quds", [
	...
	"2034" : helpers.makeTestYear("Asia/Quds", [
	...
	"2035" : helpers.makeTestYear("Asia/Quds", [
	...
	"2036" : helpers.makeTestYear("Asia/Quds", [
	...
	"2037" : helpers.makeTestYear("Asia/Quds", [
