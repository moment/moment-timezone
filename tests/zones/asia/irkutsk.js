...
exports["Asia/Irkutsk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Asia/Irkutsk", { offset: true, expect: "Etc/GMT-8" }),

	"guess:by:abbr" : helpers.makeTestGuess("Asia/Irkutsk", { abbr: true, expect: "Etc/GMT-8" }),
