...
exports["Pacific/Kosrae"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Pacific/Kosrae", { offset: true, expect: "Pacific/Pohnpei" }),

	"guess:by:abbr" : helpers.makeTestGuess("Pacific/Kosrae", { abbr: true, expect: "Pacific/Pohnpei" }),
