...
exports["Pacific/Norfolk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Pacific/Norfolk", { offset: true, expect: "Asia/Sakhalin" }),

	"guess:by:abbr" : helpers.makeTestGuess("Pacific/Norfolk", { abbr: true, expect: "Asia/Sakhalin" }),
