...
exports["Pacific/Majuro"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Pacific/Majuro", { offset: true, expect: "Pacific/Tarawa" }),

	"guess:by:abbr" : helpers.makeTestGuess("Pacific/Majuro", { abbr: true, expect: "Pacific/Tarawa" }),
