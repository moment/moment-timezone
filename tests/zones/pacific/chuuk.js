...
exports["Pacific/Chuuk"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Pacific/Chuuk", { offset: true, expect: "Pacific/Port_Moresby" }),

	"guess:by:abbr" : helpers.makeTestGuess("Pacific/Chuuk", { abbr: true, expect: "Pacific/Port_Moresby" }),
