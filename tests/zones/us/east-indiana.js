...
exports["US/East-Indiana"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("US/East-Indiana", { offset: true, expect: "EST5EDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("US/East-Indiana", { abbr: true, expect: "EST5EDT" }),
