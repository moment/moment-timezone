...
exports["US/Pacific-New"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("US/Pacific-New", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("US/Pacific-New", { abbr: true, expect: "PST8PDT" }),
