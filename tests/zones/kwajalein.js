...
exports["Kwajalein"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Kwajalein", { offset: true, expect: "Pacific/Tarawa" }),

	"guess:by:abbr" : helpers.makeTestGuess("Kwajalein", { abbr: true, expect: "Pacific/Tarawa" }),
