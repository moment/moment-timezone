...
exports["Atlantic/Cape_Verde"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Atlantic/Cape_Verde", { offset: true, expect: "Etc/GMT+1" }),

	"guess:by:abbr" : helpers.makeTestGuess("Atlantic/Cape_Verde", { abbr: true, expect: "Etc/GMT+1" }),
