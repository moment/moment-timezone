...
exports["Atlantic/Reykjavik"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Atlantic/Reykjavik", { offset: true, expect: "Etc/UTC" }),

	"guess:by:abbr" : helpers.makeTestGuess("Atlantic/Reykjavik", { abbr: true, expect: "Etc/UTC" }),
