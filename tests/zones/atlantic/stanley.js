...
exports["Atlantic/Stanley"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Atlantic/Stanley", { offset: true, expect: "Etc/GMT+3" }),

	"guess:by:abbr" : helpers.makeTestGuess("Atlantic/Stanley", { abbr: true, expect: "Etc/GMT+3" }),
