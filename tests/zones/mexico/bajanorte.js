...
exports["Mexico/BajaNorte"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Mexico/BajaNorte", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("Mexico/BajaNorte", { abbr: true, expect: "PST8PDT" }),
