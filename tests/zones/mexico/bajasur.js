...
exports["Mexico/BajaSur"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Mexico/BajaSur", { offset: true, expect: "America/Phoenix" }),

	"guess:by:abbr" : helpers.makeTestGuess("Mexico/BajaSur", { abbr: true, expect: "America/Phoenix" }),
