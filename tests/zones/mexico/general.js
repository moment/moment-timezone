...
exports["Mexico/General"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Mexico/General", { offset: true, expect: "America/Monterrey" }),

	"guess:by:abbr" : helpers.makeTestGuess("Mexico/General", { abbr: true, expect: "America/Monterrey" }),
