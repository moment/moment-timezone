...
exports["Canada/Mountain"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Canada/Mountain", { offset: true, expect: "MST7MDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("Canada/Mountain", { abbr: true, expect: "MST7MDT" }),
