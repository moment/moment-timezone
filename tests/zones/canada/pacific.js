...
exports["Canada/Pacific"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Canada/Pacific", { offset: true, expect: "PST8PDT" }),

	"guess:by:abbr" : helpers.makeTestGuess("Canada/Pacific", { abbr: true, expect: "PST8PDT" }),
