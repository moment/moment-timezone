...
exports["Canada/Pacific"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Canada/Pacific", { offset: true, expect: "America/Vancouver" }),

	"guess:by:abbr" : helpers.makeTestGuess("Canada/Pacific", { abbr: true, expect: "America/Vancouver" }),
	...
	"2026" : helpers.makeTestYear("Canada/Pacific", [
		...
		["2026-11-01T09:00:00+00:00", "02:00:00", "MST", 420]
	])
};