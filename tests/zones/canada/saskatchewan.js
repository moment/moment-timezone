...
exports["Canada/Saskatchewan"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Canada/Saskatchewan", { offset: true, expect: "Pacific/Galapagos" }),

	"guess:by:abbr" : helpers.makeTestGuess("Canada/Saskatchewan", { abbr: true, expect: "America/Tegucigalpa" }),
