...
exports.countries = {
	...
	country_zones : function (test) {
		...
		test.deepEqual(tz.zonesForCountry("AG"), ["America/Port_of_Spain","America/Antigua"]);
		test.deepEqual(tz.zonesForCountry("AI"), ["America/Port_of_Spain","America/Anguilla"]);
		...
		test.deepEqual(tz.zonesForCountry("AQ"), ["Antarctica/Casey","Antarctica/Davis","Antarctica/DumontDUrville","Antarctica/Mawson","Antarctica/Palmer","Antarctica/Rothera","Antarctica/Syowa","Antarctica/Troll","Antarctica/Vostok","Pacific/Auckland","Antarctica/McMurdo"]);
		test.deepEqual(tz.zonesForCountry("AR"), ["America/Argentina/Buenos_Aires","America/Argentina/Cordoba","America/Argentina/Salta","America/Argentina/Jujuy","America/Argentina/Tucuman","America/Argentina/Catamarca","America/Argentina/La_Rioja","America/Argentina/San_Juan","America/Argentina/Mendoza","America/Argentina/San_Luis","America/Argentina/Rio_Gallegos","America/Argentina/Ushuaia"]);
		test.deepEqual(tz.zonesForCountry("AS"), ["Pacific/Pago_Pago"]);
		test.deepEqual(tz.zonesForCountry("AT"), ["Europe/Vienna"]);
		test.deepEqual(tz.zonesForCountry("AU"), ["Australia/Lord_Howe","Antarctica/Macquarie","Australia/Hobart","Australia/Currie","Australia/Melbourne","Australia/Sydney","Australia/Broken_Hill","Australia/Brisbane","Australia/Lindeman","Australia/Adelaide","Australia/Darwin","Australia/Perth","Australia/Eucla"]);
		test.deepEqual(tz.zonesForCountry("AW"), ["America/Curacao","America/Aruba"]);
		...
		test.deepEqual(tz.zonesForCountry("BH"), ["Asia/Qatar","Asia/Bahrain"]);
		test.deepEqual(tz.zonesForCountry("BI"), ["Africa/Maputo","Africa/Bujumbura"]);
		...
		test.deepEqual(tz.zonesForCountry("BR"), ["America/Noronha","America/Belem","America/Fortaleza","America/Recife","America/Araguaina","America/Maceio","America/Bahia","America/Sao_Paulo","America/Campo_Grande","America/Cuiaba","America/Santarem","America/Porto_Velho","America/Boa_Vista","America/Manaus","America/Eirunepe","America/Rio_Branco"]);
		test.deepEqual(tz.zonesForCountry("BS"), ["America/Nassau"]);
		test.deepEqual(tz.zonesForCountry("BT"), ["Asia/Thimphu"]);
		test.deepEqual(tz.zonesForCountry("BW"), ["Africa/Maputo","Africa/Gaborone"]);
		test.deepEqual(tz.zonesForCountry("BY"), ["Europe/Minsk"]);
		test.deepEqual(tz.zonesForCountry("BZ"), ["America/Belize"]);
		test.deepEqual(tz.zonesForCountry("CA"), ["America/St_Johns","America/Halifax","America/Glace_Bay","America/Moncton","America/Goose_Bay","America/Blanc-Sablon","America/Toronto","America/Nipigon","America/Thunder_Bay","America/Iqaluit","America/Pangnirtung","America/Atikokan","America/Winnipeg","America/Rainy_River","America/Resolute","America/Rankin_Inlet","America/Regina","America/Swift_Current","America/Edmonton","America/Cambridge_Bay","America/Yellowknife","America/Inuvik","America/Creston","America/Dawson_Creek","America/Fort_Nelson","America/Vancouver","America/Whitehorse","America/Dawson"]);
		test.deepEqual(tz.zonesForCountry("CC"), ["Indian/Cocos"]);
		test.deepEqual(tz.zonesForCountry("CD"), ["Africa/Maputo","Africa/Lagos","Africa/Kinshasa","Africa/Lubumbashi"]);
		test.deepEqual(tz.zonesForCountry("CF"), ["Africa/Lagos","Africa/Bangui"]);
		test.deepEqual(tz.zonesForCountry("CG"), ["Africa/Lagos","Africa/Brazzaville"]);
		...
		test.deepEqual(tz.zonesForCountry("CL"), ["America/Santiago","America/Punta_Arenas","Pacific/Easter"]);
		test.deepEqual(tz.zonesForCountry("CM"), ["Africa/Lagos","Africa/Douala"]);
		...
		test.deepEqual(tz.zonesForCountry("CY"), ["Asia/Nicosia","Asia/Famagusta"]);
		test.deepEqual(tz.zonesForCountry("CZ"), ["Europe/Prague"]);
		test.deepEqual(tz.zonesForCountry("DE"), ["Europe/Zurich","Europe/Berlin","Europe/Busingen"]);
		test.deepEqual(tz.zonesForCountry("DJ"), ["Africa/Nairobi","Africa/Djibouti"]);
		test.deepEqual(tz.zonesForCountry("DK"), ["Europe/Copenhagen"]);
		test.deepEqual(tz.zonesForCountry("DM"), ["America/Port_of_Spain","America/Dominica"]);
		...
		test.deepEqual(tz.zonesForCountry("ER"), ["Africa/Nairobi","Africa/Asmara"]);
		test.deepEqual(tz.zonesForCountry("ES"), ["Europe/Madrid","Africa/Ceuta","Atlantic/Canary"]);
		test.deepEqual(tz.zonesForCountry("ET"), ["Africa/Nairobi","Africa/Addis_Ababa"]);
		...
		test.deepEqual(tz.zonesForCountry("FM"), ["Pacific/Chuuk","Pacific/Pohnpei","Pacific/Kosrae"]);
		...
		test.deepEqual(tz.zonesForCountry("GD"), ["America/Port_of_Spain","America/Grenada"]);
		test.deepEqual(tz.zonesForCountry("GE"), ["Asia/Tbilisi"]);
		test.deepEqual(tz.zonesForCountry("GF"), ["America/Cayenne"]);
		test.deepEqual(tz.zonesForCountry("GG"), ["Europe/London","Europe/Guernsey"]);
		test.deepEqual(tz.zonesForCountry("GH"), ["Africa/Accra"]);
		test.deepEqual(tz.zonesForCountry("GI"), ["Europe/Gibraltar"]);
		test.deepEqual(tz.zonesForCountry("GL"), ["America/Godthab","America/Danmarkshavn","America/Scoresbysund","America/Thule"]);
		...
		test.deepEqual(tz.zonesForCountry("GP"), ["America/Port_of_Spain","America/Guadeloupe"]);
		...
		test.deepEqual(tz.zonesForCountry("ID"), ["Asia/Jakarta","Asia/Pontianak","Asia/Makassar","Asia/Jayapura"]);
		test.deepEqual(tz.zonesForCountry("IE"), ["Europe/Dublin"]);
		test.deepEqual(tz.zonesForCountry("IL"), ["Asia/Jerusalem"]);
		test.deepEqual(tz.zonesForCountry("IM"), ["Europe/London","Europe/Isle_of_Man"]);
		...
		test.deepEqual(tz.zonesForCountry("JE"), ["Europe/London","Europe/Jersey"]);
		...
		test.deepEqual(tz.zonesForCountry("KI"), ["Pacific/Tarawa","Pacific/Enderbury","Pacific/Kiritimati"]);
		...
		test.deepEqual(tz.zonesForCountry("KW"), ["Asia/Riyadh","Asia/Kuwait"]);
		test.deepEqual(tz.zonesForCountry("KY"), ["America/Panama","America/Cayman"]);
		test.deepEqual(tz.zonesForCountry("KZ"), ["Asia/Almaty","Asia/Qyzylorda","Asia/Qostanay","Asia/Aqtobe","Asia/Aqtau","Asia/Atyrau","Asia/Oral"]);
		...
		test.deepEqual(tz.zonesForCountry("LI"), ["Europe/Zurich","Europe/Vaduz"]);
		...
		test.deepEqual(tz.zonesForCountry("MF"), ["America/Port_of_Spain","America/Marigot"]);
		test.deepEqual(tz.zonesForCountry("MG"), ["Africa/Nairobi","Indian/Antananarivo"]);
		test.deepEqual(tz.zonesForCountry("MH"), ["Pacific/Majuro","Pacific/Kwajalein"]);
		...
		test.deepEqual(tz.zonesForCountry("MN"), ["Asia/Ulaanbaatar","Asia/Hovd","Asia/Choibalsan"]);
		...
		test.deepEqual(tz.zonesForCountry("MS"), ["America/Port_of_Spain","America/Montserrat"]);
		...
		test.deepEqual(tz.zonesForCountry("MW"), ["Africa/Maputo","Africa/Blantyre"]);
		test.deepEqual(tz.zonesForCountry("MX"), ["America/Mexico_City","America/Cancun","America/Merida","America/Monterrey","America/Matamoros","America/Mazatlan","America/Chihuahua","America/Ojinaga","America/Hermosillo","America/Tijuana","America/Bahia_Banderas"]);
		...
		test.deepEqual(tz.zonesForCountry("PF"), ["Pacific/Tahiti","Pacific/Marquesas","Pacific/Gambier"]);
		test.deepEqual(tz.zonesForCountry("PG"), ["Pacific/Port_Moresby","Pacific/Bougainville"]);
		...
		test.deepEqual(tz.zonesForCountry("PT"), ["Europe/Lisbon","Atlantic/Madeira","Atlantic/Azores"]);
		...
		test.deepEqual(tz.zonesForCountry("RU"), ["Europe/Kaliningrad","Europe/Moscow","Europe/Simferopol","Europe/Kirov","Europe/Astrakhan","Europe/Volgograd","Europe/Saratov","Europe/Ulyanovsk","Europe/Samara","Asia/Yekaterinburg","Asia/Omsk","Asia/Novosibirsk","Asia/Barnaul","Asia/Tomsk","Asia/Novokuznetsk","Asia/Krasnoyarsk","Asia/Irkutsk","Asia/Chita","Asia/Yakutsk","Asia/Khandyga","Asia/Vladivostok","Asia/Ust-Nera","Asia/Magadan","Asia/Sakhalin","Asia/Srednekolymsk","Asia/Kamchatka","Asia/Anadyr"]);
		test.deepEqual(tz.zonesForCountry("RW"), ["Africa/Maputo","Africa/Kigali"]);
		...
		test.deepEqual(tz.zonesForCountry("SJ"), ["Europe/Oslo","Arctic/Longyearbyen"]);
		test.deepEqual(tz.zonesForCountry("SK"), ["Europe/Prague","Europe/Bratislava"]);
		...
		test.deepEqual(tz.zonesForCountry("SO"), ["Africa/Nairobi","Africa/Mogadishu"]);
		...
		test.deepEqual(tz.zonesForCountry("TF"), ["Indian/Reunion","Indian/Kerguelen"]);
		...
		test.deepEqual(tz.zonesForCountry("TZ"), ["Africa/Nairobi","Africa/Dar_es_Salaam"]);
		test.deepEqual(tz.zonesForCountry("UA"), ["Europe/Simferopol","Europe/Kiev","Europe/Uzhgorod","Europe/Zaporozhye"]);
		test.deepEqual(tz.zonesForCountry("UG"), ["Africa/Nairobi","Africa/Kampala"]);
		test.deepEqual(tz.zonesForCountry("UM"), ["Pacific/Pago_Pago","Pacific/Wake","Pacific/Honolulu","Pacific/Midway"]);
		...
		test.deepEqual(tz.zonesForCountry("YE"), ["Asia/Riyadh","Asia/Aden"]);
		...
		test.deepEqual(tz.zonesForCountry("ZM"), ["Africa/Maputo","Africa/Lusaka"]);
		test.deepEqual(tz.zonesForCountry("ZW"), ["Africa/Maputo","Africa/Harare"]);
