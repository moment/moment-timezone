...
exports.rules = {
	...
	"contains year" : function (test) {
		...
		var exact = moment.tz.addRule("TEST,2008,2010,2,1,0,0,D");
	...
	"contains month" : function (test) {
		...
		var exact = moment.tz.addRule("TEST,2009,2009,2,1,0,0,D");
	...
	"contains date equal" : function (test) {
		...
		var exact = moment.tz.addRule("TEST,2009,2009,2,2,0,0,D");
	...
	"contains minutes" : function (test) {
		...
		var exact = moment.tz.addRule("TEST,2009,2009,2,2,60,0,D");
